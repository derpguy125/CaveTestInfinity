...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("caveTestInfinity", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("caveTestInfinity", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "dg125";
		app.meta["file"] = "caveTestInfinity";
		app.meta["name"] = "caveTestInfinity";
